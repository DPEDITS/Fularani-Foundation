  ...
  >
    <div className="grid md:grid-cols-2 gap-8 md:gap-12 p-6 md:p-14 items-center">
      ...
      <div className="relative">
        <div className="absolute -top-10 -left-10 w-24 h-24 md:w-32 md:h-32 bg-red-100 rounded-full blur-3xl opacity-20 animate-pulse"></div>
        <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-red-50 text-[#ff3b30] flex items-center justify-center mb-4 md:mb-6 shadow-sm">
          <Heart size={20} className="animate-bounce lg:w-6 lg:h-6" />
        </div>
        <span className="text-[#ff3b30] font-black text-[11px] md:text-[14px] tracking-wider md:tracking-[0.2em] uppercase mb-2 md:mb-4 block">
          Urgent Appeal: Save Little Lives
        </span>

        <h3 className="text-[28px] md:text-[44px] font-black text-[#1d1d1f] leading-none mb-4 md:mb-6 tracking-tight">
          Mission <span className="text-[#ff3b30]">Thalassemia</span>
        </h3>

        <div className="space-y-4 md:space-y-6 text-[14px] md:text-[18px] text-[#424245] leading-snug md:leading-relaxed font-bold italic">
          <p className="border-l-[3px] md:border-l-4 border-red-500 pl-3 md:pl-4 py-1.5 md:py-2 bg-red-50/50 rounded-r-xl">
          ...
          <p>
            ...
            approximately{" "}
            <span className="text-[#ff3b30] text-2xl md:text-3xl font-black not-italic inline-block md:block mt-1 md:mt-2 mr-1">
              ₹90 Lakhs
            </span>{" "}
      ...
      {/* VISUAL */}
      <div className="relative h-40 md:h-70 mx-0 md:mx-auto w-full rounded-3xl md:rounded-[2.5rem] bg-[#f5f5f7] flex items-center justify-center overflow-hidden shadow-inner border border-red-50">
        <div className="absolute inset-0 bg-gradient-to-br from-red-100 via-white to-orange-50 opacity-60"></div>
        <div className="relative z-10 text-center">
          <Heart className="text-[#ff3b30] mx-auto mb-3 md:mb-6 opacity-80 w-12 h-12 md:w-16 md:h-16" />
          <div className="text-[12px] md:text-[12px] font-black text-[#ff3b30] uppercase tracking-widest md:tracking-[0.3em]">
