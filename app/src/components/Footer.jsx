...
const Footer = () => {
  ...
  return (
    <footer className="bg-secondary text-white pt-12 md:pt-24 pb-8 md:pb-12 px-6 overflow-hidden relative">
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 py-8 md:py-12 border-y border-white/10 mb-8 md:mb-12">
          <Badge
