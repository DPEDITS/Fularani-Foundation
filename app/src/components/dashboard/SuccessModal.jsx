...
const SuccessModal = ({ show, onClose, amount, formatCurrency, donorName }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white w-full max-w-md rounded-[32px] p-10 shadow-2xl animate-in zoom-in-95 duration-300 text-center relative overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="relative z-10">
          ...
          <p className="text-[#86868b] mb-6">Your donation was successful</p>
            ...
            <div className="animate-in slide-in-from-bottom-4 duration-300">
              ...
              <div className="grid grid-cols-5 gap-2 mb-5">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-green-50 transition-all group active:scale-90"
                  title="Share on WhatsApp"
                >
                  <div className="w-11 h-11 rounded-full bg-[#25D366] flex items-center justify-center shadow-md shadow-[#25D366]/20 group-hover:shadow-lg group-hover:shadow-[#25D366]/30 transition-all group-hover:-translate-y-0.5">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-blue-50 transition-all group active:scale-90"
                  title="Share on Facebook"
                >
                  <div className="w-11 h-11 rounded-full bg-[#1877F2] flex items-center justify-center shadow-md shadow-[#1877F2]/20 group-hover:shadow-lg group-hover:shadow-[#1877F2]/30 transition-all group-hover:-translate-y-0.5">
                    <svg viewBox="0 0 24 24" fill="white" className="w-5 h-5">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-gray-50 transition-all group active:scale-90"
                  title="Share on X"
                >
                  <div className="w-11 h-11 rounded-full bg-[#000000] flex items-center justify-center shadow-md shadow-black/20 group-hover:shadow-lg group-hover:shadow-black/30 transition-all group-hover:-translate-y-0.5">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-pink-50 transition-all group active:scale-90"
                  title="Save image to share on Instagram"
                >
                  <div
                    className="w-11 h-11 rounded-full flex items-center justify-center shadow-md shadow-pink-500/20 group-hover:shadow-lg group-hover:shadow-pink-500/30 transition-all group-hover:-translate-y-0.5"
                    style={{
                      background:
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-gray-100 transition-all group active:scale-90"
                  title={copied ? "Copied!" : "Copy caption"}
                >
                  <div
                    className={`w-11 h-11 rounded-full flex items-center justify-center shadow-md transition-all group-hover:-translate-y-0.5 ${copied ? "bg-emerald-500 shadow-emerald-500/20" : "bg-gray-700 shadow-gray-700/20 group-hover:shadow-lg group-hover:shadow-gray-700/30"}`}
                  >
                    {copied ? (
              ...
              {typeof navigator !== "undefined" && navigator.share && (
                <button
                  ...
                  className="w-full py-3 mb-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-semibold text-sm transition-all active:scale-95 flex items-center justify-center gap-2"
                >
                  <Share2 size={16} />
              ...
              <button
                onClick={handleDownloadImage}
                className="w-full py-3 mb-3 bg-gradient-to-r from-amber-400 to-orange-400 hover:from-amber-500 hover:to-orange-500 text-white rounded-xl font-semibold text-sm transition-all shadow-md shadow-amber-400/20 active:scale-95 flex items-center justify-center gap-2"
              >
                <Download size={16} />
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-3.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-bold text-sm transition-all active:scale-95"
                >
                  Back
                </button>
                <button
                  onClick={onClose}
                  className="flex-1 py-3.5 bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white rounded-xl font-bold text-sm transition-all shadow-lg shadow-rose-500/20 active:scale-95"
                >
                  Continue
                </button>
              </div>
