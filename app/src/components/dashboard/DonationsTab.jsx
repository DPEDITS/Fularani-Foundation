  ...
  if (donations.length === 0) {
    return (
      <div className="bg-white p-10 rounded-[40px] shadow-xl border border-secondary/10 text-center py-24">
        ...
        <p className="text-secondary/60 font-black text-lg mb-6 tracking-tight">
          Your story of impact starts here.
        </p>
        <button
    ...
    <>
      <div className="relative grid grid-cols-1 lg:grid-cols-[1fr_80px] gap-8">
                          ...
                          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
                            ...
                            <div>
                              <div className="flex items-center gap-3 mb-1">
                                ...
                                <span className="px-2 py-0.5 bg-green-50 text-green-600 text-[8px] font-black rounded-sm uppercase tracking-widest border border-green-100">
                                  Success
                                </span>
                              </div>
                              <p className="text-secondary/40 text-[10px] font-black uppercase tracking-[0.1em]">
        ...
        <div className="hidden lg:flex flex-col gap-2 sticky top-48 h-fit">
          <p className="text-[8px] font-black uppercase tracking-[0.3em] text-secondary/30 mb-4 rotate-180 [writing-mode:vertical-lr] mx-auto">
            Quick Jump
          </p>
          {years.map((year) => (
            <a
