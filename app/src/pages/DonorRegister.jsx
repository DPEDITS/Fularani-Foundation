...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, Heart, ShieldCheck } from "lucide-react";
        ...
        <main className="min-h-screen bg-[#fbfbfd] flex items-center justify-center p-6 pt-32 pb-20">
            <div className="max-w-[440px] w-full">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-[32px] font-bold text-[#1d1d1f] tracking-tight mb-2">Create Account</h1>
                    <p className="text-[17px] text-[#86868b] font-medium">Join our mission and make a difference today.</p>
                </div>
                ...
                <div className="apple-card p-8 md:p-10">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full h-14 bg-[#0071e3] text-white rounded-2xl font-bold hover:bg-[#0077ed] transition-all flex items-center justify-center gap-2 group pt-1"
                        >
                            Create Account
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-[15px] text-[#86868b] font-medium">
                            ...
                            <a href="/donor-login" className="text-[#0066cc] font-bold hover:underline">
                                Sign In
                            </a>
                        </p>
                    </div>
