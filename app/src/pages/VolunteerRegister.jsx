...
const VolunteerRegister = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Volunteer Register Data:", form);
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  focus:border-red-500 focus:ring-4 focus:ring-red-500/10 outline-none"
                />
              </div>
              ...
              {/* Google Button – SAME AS DONOR */}
              <button
                type="button"
                className="w-full md:w-9 md:h-9 py-3 px-4 md:p-0 rounded-xl md:rounded-full
                border border-gray-200 flex items-center justify-center gap-3 md:gap-0
