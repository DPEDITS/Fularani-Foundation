  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-20 px-6 font-sans">
      <div className="max-w-[640px] mx-auto text-center">
        ...
        <p className="text-[19px] text-[#86868b] mb-12">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 md:gap-12 mb-12 text-[#1d1d1f] font-medium border-b border-gray-100 pb-12">
          <a
            ...
            className="flex items-center justify-center gap-2 hover:text-[#0071e3] transition-colors"
          >
          ...
          {submitStatus === "success" ? (
            ...
            <form onSubmit={handleSubmit} className="text-left space-y-5">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-[#86868b] uppercase ml-1">
                  Message
                </label>
                <textarea
                  name="message"
